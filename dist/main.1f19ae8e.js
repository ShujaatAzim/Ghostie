...
var Et = (e, t, r) => t in e ? Gt(e, t, {
  ...
  value: r
    ...
    ne = (e, t) => {
  for (var r in t || (t = {})) En.call(t, r) && Et(e, r, t[r]);

  if (zt) for (var r of zt(t)) vn.call(t, r) && Et(e, r, t[r]);
  return e;
},
    ie = (e, t) => xn(e, wn(t));
...
function a(...e) {
  if (e.length === 0) return a(0, 0);

  if (e.length === 1) {
    if (typeof e[0] == "number") return a(e[0], e[0]);
    if (Le(e[0])) return a(e[0].x, e[0].y);
    if (Array.isArray(e[0]) && e[0].length === 2) return a.apply(null, e[0]);
  }
...
function N(...e) {
  ...
  if (e.length === 1) {
    if (Xe(e[0])) return N(e[0].r, e[0].g, e[0].b);
...
function ue(e) {
  return {
    ...
    mult(t) {
      ...
      for (let u = 0; u < 4; u++) for (let b = 0; b < 4; b++) r[u * 4 + b] = this.m[0 * 4 + b] * t.m[u * 4 + 0] + this.m[1 * 4 + b] * t.m[u * 4 + 1] + this.m[2 * 4 + b] * t.m[u * 4 + 2] + this.m[3 * 4 + b] * t.m[u * 4 + 3];
    ...
    invert() {
      let t = [],
          ...
          T = this.m[8] * this.m[13] - this.m[12] * this.m[9],
          ...
          oe = this.m[5] * this.m[15] - this.m[13] * this.m[7],
          j = this.m[4] * this.m[13] - this.m[12] * this.m[5],
          J = this.m[6] * this.m[11] - this.m[10] * this.m[7],
          K = this.m[5] * this.m[11] - this.m[9] * this.m[7],
      ...
      for (let I = 0; I < 4; I++) for (let $ = 0; $ < 4; $++) t[I * 4 + $] *= 1 / S;
...
function Ct(e) {
  return {
    ...
    gen(...t) {
      if (t.length === 0) return this.seed = (Cn * this.seed + Pn) % er, this.seed / er;

      if (t.length === 1) {
        if (typeof t[0] == "number") return this.gen(0, t[0]);
        if (Le(t[0])) return this.gen(a(0, 0), t[0]);
        if (Xe(t[0])) return this.gen(N(0, 0, 0), t[0]);
      } else if (t.length === 2) {
        if (typeof t[0] == "number" && typeof t[1] == "number") return this.gen() * (t[1] - t[0]) + t[0];
        if (Le(t[0]) && Le(t[1])) return a(this.gen(t[0].x, t[1].x), this.gen(t[0].y, t[1].y));
        if (Xe(t[0]) && Xe(t[1])) return N(this.gen(t[0].r, t[1].r), this.gen(t[0].g, t[1].g), this.gen(t[0].b, t[1].b));
      }
    }
...
function Dt(e, t) {
  ...
  if (r === 0) return null;
  let u = ((t.p2.x - t.p1.x) * (e.p1.y - t.p1.y) - (t.p2.y - t.p1.y) * (e.p1.x - t.p1.x)) / r,
      b = ((e.p2.x - e.p1.x) * (e.p1.y - t.p1.y) - (e.p2.y - e.p1.y) * (e.p1.x - t.p1.x)) / r;
...
function it(e, t) {
  return we(e, t.p1) || we(e, t.p2) ? !0 : !!Pe(t, ht(e.p1, a(e.p2.x, e.p1.y))) || !!Pe(t, ht(a(e.p2.x, e.p1.y), e.p2)) || !!Pe(t, ht(e.p2, a(e.p1.x, e.p2.y))) || !!Pe(t, ht(a(e.p1.x, e.p2.y), e.p1));
}
...
function He(e, t) {
  if (We(t, e.p1) || We(t, e.p2)) return !0;
...
function dt(e, t) {
  return {
    p1: a(e.p1.x - t.p2.x, e.p1.y - t.p2.y),
    p2: a(e.p2.x - t.p1.x, e.p2.y - t.p1.y)
  };
}
...
function Mt(e, t) {
  ...
  if (r === "object" && u === "object") {
    ...
    for (let v of b) {
      let T = e[v],
          D = t[v];
      if (!(typeof T == "function" && typeof D == "function") && !Mt(T, D)) return !1;
    }
...
function lr(e, t) {
  let r = (() => {
    var C;
    let o = B(_t, Ft),
        h = b(new ImageData(new Uint8ClampedArray([255, 255, 255, 255]), 1, 1)),
        y = (C = t.background) != null ? C : N(0, 0, 0);
    ...
    let w = b(new ImageData(new Uint8ClampedArray([128, 128, 128, 255, 190, 190, 190, 255, 190, 190, 190, 255, 128, 128, 128, 255]), 2, 2), {
      wrap: "repeat",
      filter: "nearest"
    });
    return {
  ...
  function B(o = _t, h = Ft) {
    let y,
        R = Dn.replace("{{user}}", o != null ? o : _t),
        x = Tn.replace("{{user}}", h != null ? h : Ft),
        w = e.createShader(e.VERTEX_SHADER),
        C = e.createShader(e.FRAGMENT_SHADER);
    if (e.shaderSource(w, R), e.shaderSource(C, x), e.compileShader(w), e.compileShader(C), y = e.getShaderInfoLog(w)) throw new Error(y);
    if (y = e.getShaderInfoLog(C)) throw new Error(y);
...
`) throw new Error(y);
    return {
      ...
      bindAttribs() {
        e.vertexAttribPointer(0, 3, e.FLOAT, !1, Qe * 4, 0), e.enableVertexAttribArray(0), e.vertexAttribPointer(1, 2, e.FLOAT, !1, Qe * 4, 12), e.enableVertexAttribArray(1), e.vertexAttribPointer(2, 4, e.FLOAT, !1, Qe * 4, 20), e.enableVertexAttribArray(2);
      },
      ...
      send(G) {
        ...
        for (let se in G) {
          let O = G[se],
              re = e.getUniformLocation(F, se);
          typeof O == "number" ? e.uniform1f(re, O) : Qt(O) ? e.uniformMatrix4fv(re, !1, new Float32Array(O.m)) : Xe(O) ? e.uniform4f(re, O.r, O.g, O.b, O.a) : Ht(O) ? e.uniform3f(re, O.x, O.y, O.z) : Le(O) && e.uniform2f(re, O.x, O.y);
        }
  ...
  function v(o, h, y, R) {
    ...
    for (let [O, re] of se) G[re] = a(O % x * C, Math.floor(O / x) * F);
  ...
  function z() {
    e.clear(e.COLOR_BUFFER_BIT), t.background || S({
      width: be(),
      height: ve(),
      quad: ce(0, 0, be() * Be() / cr, ve() * Be() / cr),
      tex: r.bgTex
    }), r.drawCalls = 0, r.transformStack = [], r.transform = ue();
  }
  ...
  function S(o) {
    ...
    let h = o.width,
        y = o.height,
        x = qe(o.origin || ft).scale(a(h, y).scale(-.5)),
        w = o.quad || ce(0, 0, 1, 1),
        C = o.color || N(255, 255, 255),
        F = (G = o.opacity) != null ? G : 1;
    pe(), j(o.pos), m(o.angle), J(o.scale), j(x), T([{
      pos: Ce(-h / 2, y / 2, 0),
      uv: a(o.flipX ? w.x + w.w : w.x, o.flipY ? w.y : w.y + w.h),
      color: C,
      opacity: F
    }, {
      pos: Ce(-h / 2, -y / 2, 0),
      uv: a(o.flipX ? w.x + w.w : w.x, o.flipY ? w.y + w.h : w.y),
      color: C,
      opacity: F
    }, {
      pos: Ce(h / 2, -y / 2, 0),
      uv: a(o.flipX ? w.x : w.x + w.w, o.flipY ? w.y + w.h : w.y),
      color: C,
      opacity: F
    }, {
      pos: Ce(h / 2, y / 2, 0),
      uv: a(o.flipX ? w.x : w.x + w.w, o.flipY ? w.y : w.y + w.h),
      color: C,
      opacity: F
    }], [0, 1, 3, 1, 2, 3], o.tex, o.shader, o.uniform), A();
  }
  ...
  function I(o) {
    ...
    let h = (w = o.quad) != null ? w : ce(0, 0, 1, 1),
        y = o.tex.width * h.w,
        R = o.tex.height * h.h,
        x = a(1);

    if (o.tiled) {
      let C = Math.ceil((o.width || y) / y),
          F = Math.ceil((o.height || R) / R),
          se = qe(o.origin || ft).add(a(1, 1)).scale(.5).scale(C * y, F * R);

      for (let O = 0; O < C; O++) for (let re = 0; re < F; re++) S(ie(ne({}, o), {
        pos: (o.pos || a(0)).add(a(y * O, R * re)).sub(se),
        scale: x.scale(o.scale || a(1)),
        tex: o.tex,
        quad: h,
        width: y,
        height: R,
    ...
    } else o.width && o.height ? (x.x = o.width / y, x.y = o.height / R) : o.width ? (x.x = o.width / y, x.y = x.x) : o.height && (x.y = o.height / R, x.x = x.y), S(ie(ne({}, o), {
      scale: x.scale(o.scale || a(1)),
      tex: o.tex,
      quad: h,
      width: y,
  ...
  function $(o, h, y, R, x, w = 1) {
    ...
    let C = Math.ceil(Math.max(Math.sqrt(h + y) * 3 * (w || 1), 16)),
        F = (x - R) / C,
        G = [];

    for (let se = R; se < x; se += F) G.push(o.add(h * Math.cos(se), y * Math.sin(se)));
  ...
  function _(o) {
    ...
    let h = o.width,
        y = o.height,
        x = qe(o.origin || ft).add(1, 1).scale(a(h, y).scale(-.5)),
        w = [a(0, 0), a(h, 0), a(h, y), a(0, y)];
  ...
  function L(o) {
    ...
    if (!h || !y) throw new Error('drawLine() requires properties "p1" and "p2".');
    let R = o.width || 1,
        x = y.sub(h).unit().normal().scale(R * .5),
        w = [h.sub(x), h.add(x), y.add(x), y.sub(x)].map(C => {
      var F, G;
      return {
        pos: Ce(C.x, C.y, 0),
        uv: a(0),
        color: (F = o.color) != null ? F : N(),
        opacity: (G = o.opacity) != null ? G : 1
      };
    });
  ...
  function k(o) {
    let h = o.pts;
    if (!h) throw new Error('drawLines() requires property "pts".');
    if (!(h.length < 2)) if (o.radius && h.length >= 3) {
      let y = h[0].dist(h[1]);

      for (let x = 1; x < h.length - 1; x++) y = Math.min(h[x].dist(h[x + 1]), y);
    ...
    } else for (let y = 0; y < h.length - 1; y++) L(ie(ne({}, o), {
      p1: h[y],
      p2: h[y + 1]
    }));
  }
  ...
  function M(o) {
    ...
    o.radiusX === 0 || o.radiusY === 0 || E(ie(ne({}, o), {
      pts: $(a(0), o.radiusX, o.radiusY, (h = o.start) != null ? h : 0, (y = o.end) != null ? y : 360, o.resolution),
      radius: 0
    }));
  }
  ...
  function E(o) {
    ...
    if (!(h < 3)) {
      if (pe(), j(o.pos), J(o.scale), m(o.angle), j(o.offset), o.fill !== !1) {
        let x = (y = o.color) != null ? y : N(),
            w = o.pts.map(F => {
          var G;
          return {
            pos: Ce(F.x, F.y, 0),
...
` && (he.push(Ue), se += F, Ue === " " && (ye = he.length)), re = Math.max(re, se), fe++;
    ...
    let Oe = [],
        Te = a(o.pos || 0),
        Ae = qe(o.origin || ft).scale(.5),
        Ke = -Ae.x * F - (Ae.x + .5) * (re - F),
        yt = -Ae.y * G - (Ae.y + .5) * (O - G);
    return De.forEach((Ue, bt) => {
      let et = (re - Ue.length * F) * (Ae.x + .5);
      Ue.forEach((Ye, tt) => {
        let Ge = h.map[Ye],
            Ut = tt * F,
            ze = bt * G;
        Ge && Oe.push({
          tex: h.tex,
          quad: ce(Ge.x, Ge.y, h.qw, h.qh),
          ch: Ye,
          pos: a(Te.x + Ut + Ke + et, Te.y + ze + yt),
          opacity: o.opacity,
          color: o.color,
          origin: o.origin,
          scale: C
  ...
  function Se(o) {
    for (let h of o.chars) S({
      tex: h.tex,
      width: h.tex.width * h.quad.w,
      height: h.tex.height * h.quad.h,
      pos: h.pos,
      scale: h.scale,
      color: h.color,
      opacity: h.opacity,
  ...
  function $e() {
    ...
    } else r.width = e.drawingBufferWidth / Be(), r.height = e.drawingBufferHeight / Be(), e.viewport(0, 0, e.drawingBufferWidth, e.drawingBufferHeight);
  }
...
function fr(e = {}) {
  ...
  let r = {
    ...
    " ": "space"
      ...
      b = ["space", "left", "right", "up", "down", "tab", "f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8", "f9", "f10", "f11", "s"];
  ...
  r.isTouch = "ontouchstart" in window || navigator.maxTouchPoints > 0, r.canvas.addEventListener("mousemove", E => {
    _() ? r.mousePos = a(E.offsetX, E.offsetY).scale(1 / r.scale) : r.mousePos = a(E.offsetX, E.offsetY).scale(1 / r.scale), r.mouseDeltaPos = a(E.movementX, E.movementY).scale(1 / r.scale), r.mouseMoved = !0;
    ...
    b.includes(Y) && E.preventDefault(), Y.length === 1 && r.charInputted.push(E.key), Y === "space" && r.charInputted.push(" "), E.repeat ? (r.keyPressedRep = !0, r.keyStates[Y] = "rpressed") : (r.keyPressed = !0, r.keyStates[Y] = "pressed");
    ...
    E.preventDefault();
    let Y = E.touches[0];
    r.mousePos = a(Y.clientX, Y.clientY).scale(1 / r.scale), r.mouseMoved = !0;
    ...
    switch (document.visibilityState) {
      case "visible":
        r.skipTime = !0, (E = e.audioCtx) == null || E.resume();
        break;
  ...
  function L(E) {
    let Y = s(Ee => {
      ...
      let Se = Ee / 1e3,
          $e = Se - r.realTime;
      r.realTime = Se, r.skipTime || (r.dt = $e, r.time += r.dt, r.fpsBuf.push(1 / r.dt), r.fpsTimer += r.dt, r.fpsTimer >= 1 && (r.fpsTimer = 0, r.fps = Math.round(r.fpsBuf.reduce((be, ve) => be + ve) / r.fpsBuf.length), r.fpsBuf = [])), r.skipTime = !1, E();

      for (let be in r.keyStates) r.keyStates[be] = hr(r.keyStates[be]);

      r.mouseState = hr(r.mouseState), r.charInputted = [], r.mouseMoved = !1, r.keyPressed = !1, r.keyPressedRep = !1, r.loopID = requestAnimationFrame(Y);
    }, "frame");
    r.stopped = !1, r.loopID = requestAnimationFrame(Y);
  }
  ...
  return s(k, "quit"), {
    ...
    run: L,
    quit: k,
    focused: () => document.activeElement === r.canvas,
...
function gr() {
  let e = (() => {
    let B = new (window.AudioContext || window.webkitAudioContext)(),
        v = B.createGain(),
        T = v;
    return T.connect(B.destination), {
      ctx: B,
      gainNode: v,
      masterNode: T
    };
  ...
  function u(B, v = {
    ...
    let te = e.ctx.currentTime - W,
      ...
      play(J) {
        ...
        D.start(0, de), te = e.ctx.currentTime - de, T = !1, Z = null;
      },

      pause() {
        T || (D.stop(), T = !0, Z = e.ctx.currentTime);
      },
...
function Vr(e, t, r = {}) {
  ...
  function b(A) {
    ...
    return u.loaders[S] = !1, u.lastLoaderID++, A.catch((I = r.errHandler) != null ? I : console.error).finally(() => u.loaders[S] = !0);
  }
  ...
  function B() {
    ...
    for (let I in u.loaders) A += 1, u.loaders[I] && (S += 1);
  ...
  function Z(A = 1, S = 1, I = 0, $ = 0, _ = 1, L = 1) {
    ...
    for (let M = 0; M < S; M++) for (let E = 0; E < A; E++) k.push(ce(I + E * X, $ + M * q, X, q));
    ...
    return b(typeof S == "string" ? fetch(v() + S).then(I => I.json()).then(I => oe(A, I)) : j(null, A).then(I => {
      ...
      for (let k in S) {
        let X = S[k],
            q = {
          tex: I.tex,
          frames: Z(X.sliceX, X.sliceY, X.x / _, X.y / L, X.width / _, X.height / L),
          anims: X.anims
        };
        u.sprites[k] = q, $[k] = q;
      }
  ...
  function j(A, S, I = {
    ...
    return s($, "loadRawSprite"), b(new Promise((_, L) => {
      if (!S) return L(`expected sprite src for "${A}"`);
  ...
  function J(A, S) {
    return b(new Promise((I, $) => {
      fetch(v() + S).then(_ => _.json()).then(_ => Jt(this, null, function* () {
        let L = yield Promise.all(_.frames.map(Xt)),
    ...
    return b(new Promise(($, _) => {
      ...
      j(A, S).then(k => {
        fetch(L).then(X => X.json()).then(X => {
          ...
          for (let M of X.meta.frameTags) M.from === M.to ? k.anims[M.name] = M.from : k.anims[M.name] = {
            from: M.from,
            to: M.to,
            speed: 10,
            loop: !0
  ...
  function de(A, S, I, $ = !1) {
    ...
    return s(_, "loadRawShader"), b(new Promise((L, k) => {
      ...
      if (s(X, "resolveUrl"), $) Promise.all([X(S), X(I)]).then(([q, M]) => {
        L(_(A, q, M));
      }).catch(k);else try {
        L(_(A, S, I));
      } catch (q) {
  ...
  function m(A, S) {
    let I = u.loadRoot + S;
    return b(new Promise(($, _) => {
      if (!S) return _(`expected sound src for "${A}"`);
  ...
  return s(pe, "loadBean"), T("apl386", Er, 45, 74), T("apl386o", Br, 45, 74), T("sink", Pr, 6, 8, {
...
var qr,
  ...
  qr = s(e => {
    ...
    function b(B, v = {}) {
      ...
      let T = (v.speed || 1) * 5,
          D = v.scale || 1,
          z = e.add([e.pos(B), e.sprite(u), e.scale(0), e.stay(), e.origin("center"), t(T, D), ...((te = v.boomComps) != null ? te : () => [])()]),
          W = e.add([e.pos(B), e.sprite(r), e.scale(0), e.stay(), e.origin("center"), e.timer(.4 / T, () => W.use(t(T, D))), ...((Z = v.kaComps) != null ? Z : () => [])()]);
      return {
        destroy() {
...
var zn = Bn((Is, Or) => {
  ...
  Or.exports = (e = {}) => {
    ...
    let t = gr(),
      ...
      root: e.root,
      stretch: e.stretch,
      touchToMouse: ($t = e.touchToMouse) != null ? $t : !0,
      audioCtx: t.ctx
    }),
        u = lr(r.gl, {
      background: e.background ? N(e.background) : void 0,
      width: e.width,
      height: e.height,
      scale: e.scale,
    ...
    function j(n) {
      ...
      if (!i) throw new Error(`sprite not found: "${n.sprite}"`);
      let c = i.frames[(d = n.frame) != null ? d : 0];
      if (!c) throw new Error(`frame not found: ${(U = n.frame) != null ? U : 0}`);
      u.drawTexture(ie(ne({}, n), {
        tex: i.tex,
        quad: c.scale(n.quad || ce(0, 0, 1, 1))
      }));
    }
    ...
    function J(n) {
      var d;
      let i = (d = n.font) != null ? d : D,
          c = v.fonts[i];
      if (!c) throw new Error(`font not found: ${i}`);
      u.drawText(ie(ne({}, n), {
        font: c
      }));
    }
    ...
    let k = new Set(["id", "require"]),
        X = new Set(["add", "load", "update", "draw", "destroy", "inspect"]);
    ...
    function q(n) {
      let i = new Map(),
        ...
        is(l) {
          ...
          if (Array.isArray(l)) {
            for (let f of l) if (!this.c(f)) return !1;
        ...
        inspect() {
          ...
          for (let [f, g] of i) l[f] = g.inspect ? g.inspect() : null;
    ...
    function Ee(n, i) {
      if (typeof n == "function" && i === void 0) return M([{
        update: n
      }]).destroy;
      if (typeof n == "string") return Y("update", n, i);
    }
    ...
    function Se(n, i) {
      ...
      if (typeof n == "string") return Y("draw", n, i);
    }

    s(Se, "render");

    function $e(n, i, c) {
      let d = Y("collide", n, (f, g, p) => g.is(i) && c(f, g)),
          U = Y("collide", i, (f, g, p) => g.is(n) && c(g, f)),
          l = Ee(n, f => {
        if (!f.area) throw new Error("collides() requires the object to have area() component");
    ...
    function h(n, i) {
      if (Array.isArray(n)) {
        let c = n.map(d => h(d, i));
        return () => c.forEach(d => d());
      } else return typeof n == "function" ? m.on("input", () => r.keyPressed() && n()) : m.on("input", () => r.keyPressed(n) && i());
    }
    ...
    function y(n, i) {
      if (Array.isArray(n)) {
        let c = n.map(d => y(d, i));
        return () => c.forEach(d => d());
      } else return typeof n == "function" ? m.on("input", () => r.keyPressed() && n()) : m.on("input", () => r.keyPressedRep(n) && i());
    }
    ...
    function R(n, i) {
      if (Array.isArray(n)) {
        let c = n.map(d => R(d, i));
        return () => c.forEach(d => d());
      } else return typeof n == "function" ? m.on("input", () => r.keyPressed() && n()) : m.on("input", () => r.keyReleased(n) && i());
    }
    ...
    function De() {
      h("f1", () => {
        ...
        H.timeScale = me(H.timeScale - .2, 0, 2), H.log(`time scale: ${H.timeScale.toFixed(1)}`);
      }), h("f9", () => {
        H.timeScale = me(H.timeScale + .2, 0, 2), H.log(`time scale: ${H.timeScale.toFixed(1)}`);
      }), h("f10", () => {
    ...
    function ye(n) {
      let i = [...m.objs.values()].sort((c, d) => {
        var f, g, p, V, P, Q;
        let U = (g = m.layers[(f = c.layer) != null ? f : m.defLayer]) != null ? g : 0,
            l = (V = m.layers[(p = d.layer) != null ? p : m.defLayer]) != null ? V : 0;
    ...
    function fe(n, i) {
      if (typeof n == "function" && i === void 0) return ye().forEach(c => c.exists() && n(c));
      if (typeof n == "string") return ye(n).forEach(c => c.exists() && i(c));
    }

    s(fe, "every");

    function Oe(n, i) {
      if (typeof n == "function" && i === void 0) return ye().reverse().forEach(c => c.exists() && n(c));
      if (typeof n == "string") return ye(n).reverse().forEach(c => c.exists() && i(c));
    }
    ...
    function Ue(n) {
      ...
      let c = a(b(), B()),
          d = m.cam,
          U = st(je(0, 360)).scale(d.shake);
      d.shake = Ne(d.shake, 0, 5 * W()), m.camMatrix = ue().translate(c.scale(.5)).scale(d.scale).rotateZ(d.angle).translate(c.scale(-.5)).translate(d.pos.scale(-1).add(c.scale(.5)).add(U)), fe(l => {
    ...
    function bt() {
      ...
      let n = null,
          i = v.fonts[z],
          c = N((U = e.inspectColor) != null ? U : [0, 0, 255]);
      ...
      function d(l, f) {
        let g = u.scale(),
          ...
          color: N(0, 0, 0)
            ...
            P = V.width + p.x * 2,
            Q = V.height + p.x * 2;
        u.pushTransform(), l.x + P >= b() && u.pushTranslate(a(-P, 0)), l.y + Q >= B() && u.pushTranslate(a(0, -Q)), u.drawRect({
          pos: l,
          width: P,
          height: Q,
          color: N(255, 255, 255),
        ...
        }), u.drawFmtText(V), u.popTransform();
      }
      ...
      if (s(d, "drawInspectTxt"), fe(l => {
        ...
        u.drawRect({
          ...
          fill: !1
        }), l.fixed || u.popTransform();
      }), n) {
        let l = [],
            f = n.inspect();

        for (let g in f) f[g] ? l.push(`${g}: ${f[g]}`) : l.push(`${g}`);
...
`));
      ...
      return {
        ...
        moveBy(...i) {
          ...
          if (this.solid && ((f = this.area) == null ? void 0 : f.shape) === "rect") {
            ...
            fe(p => {
              var Yt;
              if (!this.exists() || p === this || !p.solid || ((Yt = p.area) == null ? void 0 : Yt.shape) !== "rect") return;
              let V = p.worldArea(),
                  P = dt(V, g);

              if (we(P, a(0))) {
                let ge = Math.min(Math.abs(P.p1.x), Math.abs(P.p2.x), Math.abs(P.p1.y), Math.abs(P.p2.y)),
                    Me = (() => {
                  switch (ge) {
        ...
        moveTo(...i) {
          if (typeof i[0] == "number" && typeof i[1] == "number") return this.moveTo(a(i[0], i[1]), i[2]);
          let c = i[0],
              d = i[1];
    ...
    function Hr(n = {}) {
      ...
      return {
        ...
        area: {
          shape: "rect",
          offset: (c = n.offset) != null ? c : a(0),
          width: n.width,
          height: n.height,
          scale: (d = n.scale) != null ? d : a(1),
          cursor: n.cursor
        },
        ...
        collides(U, l) {
          let f = this.action(() => this._checkCollisions(U, l)),
              g = this.on("collide", (p, V) => p.is(U) && l(p, V));
        ...
        pushOut(U) {
          var P;
          if (U === this || ((P = U.area) == null ? void 0 : P.shape) !== "rect") return null;
          let l = this.worldArea(),
              f = U.worldArea(),
              g = dt(l, f);
          if (!we(g, a(0))) return null;

          let p = Math.min(Math.abs(g.p1.x), Math.abs(g.p2.x), Math.abs(g.p1.y), Math.abs(g.p2.y)),
              V = (() => {
            switch (p) {
        ...
        worldArea() {
          var V, P, Q, ee;
          let U = (V = this.area.width) != null ? V : this.width,
              l = (P = this.area.height) != null ? P : this.height;
          if (U == null || l == null) throw new Error("failed to get area dimension");
          let f = ((Q = this.scale) != null ? Q : a(1)).scale(this.area.scale);
          U *= f.x, l *= f.y;
          let g = qe(this.origin || de),
              p = ((ee = this.pos) != null ? ee : a(0)).add(this.area.offset).sub(g.add(1, 1).scale(.5).scale(U, l));
          return {
            shape: "rect",
            p1: p,
            p2: a(p.x + U, p.y + l)
        ...
        screenArea() {
          ...
          return this.fixed ? U : {
            shape: "rect",
            p1: m.camMatrix.multVec2(U.p1),
            p2: m.camMatrix.multVec2(U.p2)
          };
        }
    ...
    function Qr(n, i = {}) {
      ...
      return s(U, "calcTexScale"), {
        id: "sprite",
        width: 0,
        height: 0,
        frame: i.frame || 0,
        quad: i.quad || ce(0, 0, 1, 1),
        animSpeed: (l = i.animSpeed) != null ? l : 1,
        ...
        play(f, g = {}) {
          ...
          let p = c.anims[f];
          if (p == null) throw new Error(`anim not found: ${f}`);
          d && this.stop(), d = {
            name: f,
            timer: 0,
            loop: (P = (V = g.loop) != null ? V : p.loop) != null ? P : !1,
            pingpong: (ee = (Q = g.pingpong) != null ? Q : p.pingpong) != null ? ee : !1,
            speed: (ke = (Re = g.speed) != null ? Re : p.speed) != null ? ke : 10,
            onEnd: (Ve = g.onEnd) != null ? Ve : () => {}
    ...
    function un(n = {}) {
      ...
      return {
        id: "body",
        require: ["pos", "area"],
        jumpForce: (l = n.jumpForce) != null ? l : on,
        weight: (f = n.weight) != null ? f : 1,
        ...
        update() {
          ...
          if (c) {
            let P = this.worldArea(),
                ...
                rt = Q.p1.x,
                nt = Q.p2.x;
            !c.exists() || ee !== Re || Ve < rt || ke > nt ? (this.trigger("fall", c), c = null, d = null, p = !0) : d && c.pos && (this.pos = this.pos.add(c.pos.sub(d)), d = c.pos.clone());
          }
          ...
          if (!c) {
            ...
            if (P) if (P.isBottom()) {
              c = P.target;
              let Q = i;
              i = 0, c.pos && (d = c.pos.clone()), p || (this.trigger("ground", c), U = !0);
            } else P.isTop() && (i = 0, this.trigger("headbutt", P.target));
        ...
        doubleJump(p) {
          this.grounded() ? this.jump(p) : U && (U = !1, this.jump(p), this.trigger("doubleJump"));
        }
    ...
    let H = {
      ...
      drawCalls: u.drawCalls,
      clearLog: T.clear,
      log: n => T.info(`[${r.time().toFixed(2)}] ${n}`),
      error: n => T.error(`[${r.time().toFixed(2)}] ${n}`),
    ...
    function yn(n, ...i) {
      ...
      m.on("next", () => {
        m.events = {}, m.objEvents = {
          ...
          angle: 0,
          shake: 0
        }, m.camMousePos = r.mousePos(), m.camMatrix = ue(), m.layers = {}, m.defLayer = null, m.gravity = K, m.scenes[n](...i), e.debug !== !1 && De(), e.burp && he();
      });
    }
    ...
    function gt(n) {
      ...
      for (let c in i) Fe[c] = i[c], e.global !== !1 && (window[c] = i[c]);
      ...
      let c = [],
        ...
        spawn(f, ...g) {
          let p = a(...g),
              V = (() => {
            if (i[f]) {
              if (typeof i[f] != "function") throw new Error("level symbol def must be a function returning a component list");
              return i[f](p);
            } else if (i.any) return i.any(f, p);
          })();

          if (!V) return;
          let P = a(d.x + p.x * i.width, d.y + p.y * i.height);

          for (let ee of V) if (ee.id === "pos") {
    ...
    let Fe = {
      ...
      keyIsDown: r.keyDown,
      keyIsPressed: r.keyPressed,
      keyIsPressedRep: r.keyPressedRep,
      keyIsReleased: r.keyReleased,
      mouseIsDown: r.mouseDown,
      mouseIsClicked: r.mouseClicked,
      mouseIsReleased: r.mouseReleased,
      mouseIsMoved: r.mouseMoved,
      loop: pt,
      wait: Be,
      play: te,
      volume: t.volume,
      ...
      drawRect: u.drawRect,
      drawLine: u.drawLine,
      drawLines: u.drawLines,
      drawTriangle: u.drawTriangle,
      drawCircle: u.drawCircle,
      drawEllipse: u.drawEllipse,
      drawUVQuad: u.drawUVQuad,
      drawPolygon: u.drawPolygon,
      pushTransform: u.pushTransform,
      popTransform: u.popTransform,
      pushTranslate: u.pushTranslate,
      pushRotate: u.pushRotateZ,
      pushScale: u.pushScale,
      debug: H,
      scene: pn,
      go: yn,
      addLevel: gn,
    ...
    if (gt(qr), e.plugins && e.plugins.forEach(gt), e.global !== !1) for (let n in Fe) window[n] = Fe[n];
    let qt = 0;
    ...
    return s(Zn, "frames"), r.run(() => {
      if (qt++, u.frameStart(), m.loaded) m.camMousePos = m.camMatrix.invert().multVec2(r.mousePos()), m.trigger("input"), Ue(), H.inspect && bt(), H.showLog && T.draw();else {
        let n = v.loadProgress();
        if (n === 1) m.loaded = !0, m.trigger("load");else {
          let i = b() / 2,
              c = 24 / u.scale(),
              d = a(b() / 2, B() / 2).sub(a(i / 2, c / 2));
          u.drawRect({
            pos: a(0),
            width: b(),
            height: B(),
      ...
      u.frameEnd();
    }), e.debug !== !1 && De(), e.burp && he(), window.addEventListener("error", n => {
...
var _default = k;
exports.default = _default;
},{"kaboom":"../node_modules/kaboom/dist/kaboom.mjs"}],"scenes/Game.js":[function(require,module,exports) {
"use strict";
...
},{"./kaboom":"kaboom.js","./scenes/Game":"scenes/Game.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
